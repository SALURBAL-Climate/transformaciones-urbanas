                ...
                <Col lg={11} md={11}>
                  <ul className="custom-bullet-list">
                    ...
                    <li className="font-d-din">
                      ...
                      Cortinez-O’Ryan, A., Baeza, F., & Rasse, A. (2023). “Mi
                      vida va a ser mucho mejor de lo que ha sido”: estudio
                      cualitativo sobre el vínculo entre regeneración de
                      viviendas sociales, calidad de vida y salud. Cadernos de
                      Saúde Pública, 39, e00149822.
                    ...
                    <li className="font-d-din">
                      ...
                      (2023). Desarrollo de instrumentos para estudiar el
                      impacto en salud de las transformaciones urbanas en
                      contextos de elevada vulnerabilidad: el estudio RUCAS.
                      Cadernos de Saúde Pública, 39, e00148322.
