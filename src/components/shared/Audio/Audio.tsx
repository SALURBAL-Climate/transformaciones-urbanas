...
export default function AudioApp(props: any) {
  ...
  const audioControl: { hovered: boolean; played: boolean; color: string }[] =
    new Array(37).fill({ hovered: false, played: false, color: DEFAULT_COLOR });
  const [colorsReference, setColorsReference] = useState(
    new Array(37).fill(DEFAULT_COLOR)
  );
  let currentPos = -1;
  ...
  const playPauseAudio = async () => {
    if (reference.current) {
      ...
      handleProgress(!playing);
    }
  };

  const handleProgress = (isPlaying: boolean) => {
    if (isPlaying && reference.current) {
      const duration = reference.current.duration;
      const splitsDuration = duration / 37;
      if (currentPos === -1) {
        colorsReference[0] = PLAYING_COLOR;
        setColorsReference(colorsReference);
      }
      setTimeout(() => {
        for (let i = currentPos; i <= 36; i++) {
          if (isPlaying) {
            audioControl[i + 1].played = true;
            audioControl[i + 1].color = PLAYING_COLOR;
            colorsReference[i + 1] = PLAYING_COLOR;
            setColorsReference(colorsReference);
            currentPos = i + 1;
          }
        }

        handleProgress(isPlaying && !playing);
      }, 1000);
    }
  };
    ...
    if (reference.current) {
      ...
      if (pos > currentPos) {
        for (let i = currentPos; i <= pos; i++) {
          audioControl[i].played = true;
          audioControl[i].color = PLAYING_COLOR;
        }
      } else {
        for (let i = currentPos; i >= pos; i--) {
          audioControl[i].played = false;
          audioControl[i].color = DEFAULT_COLOR;
        }
      }
      currentPos = pos;
      console.log(`Hello??? ${playing} and ${pos}`);
      if (!playing) {
        reference.current?.play();
        setPlaying(!playing);
      }
  ...
  const handleHover = (pos: number, isHover: boolean) => {
    audioControl[pos].hovered = isHover;
    if (isHover) {
      audioControl[pos].color = HOVER_COLOR;
    } else {
      if (audioControl[pos].played) {
        audioControl[pos].color = PLAYING_COLOR;
      } else {
        audioControl[pos].color = DEFAULT_COLOR;
      }
    }
  };
        ...
        <g id="Capa_1">
          ...
          <g id="part_37">
            <path
              ...
              style={{ fill: audioControl[36].color, strokeWidth: "0px" }}
              onClick={() => {
                seekAudio(36);
              }}
              onMouseEnter={() => {
          ...
          <g id="part_36">
            <path
              ...
              style={{ fill: audioControl[35].color, strokeWidth: "0px" }}
              onClick={() => {
                seekAudio(35);
              }}
              onMouseEnter={() => {
          ...
          <g id="part_35">
            <path
              ...
              style={{ fill: audioControl[34].color, strokeWidth: "0px" }}
              onClick={() => {
                seekAudio(34);
              }}
              onMouseEnter={() => {
          ...
          <g id="part_34">
            <path
              ...
              style={{ fill: audioControl[33].color, strokeWidth: "0px" }}
              onClick={() => {
                seekAudio(33);
              }}
              onMouseEnter={() => {
          ...
          <g id="part_33">
            <path
              ...
              style={{ fill: audioControl[32].color, strokeWidth: "0px" }}
              onClick={() => {
                seekAudio(32);
              }}
              onMouseEnter={() => {
          ...
          <g id="part_32">
            <path
              ...
              style={{ fill: audioControl[31].color, strokeWidth: "0px" }}
              onClick={() => {
                seekAudio(31);
              }}
              onMouseEnter={() => {
          ...
          <g id="part_31">
            <path
              ...
              style={{ fill: audioControl[30].color, strokeWidth: "0px" }}
              onClick={() => {
                seekAudio(30);
              }}
              onMouseEnter={() => {
          ...
          <g id="part_30">
            <path
              ...
              style={{ fill: audioControl[29].color, strokeWidth: "0px" }}
              onClick={() => {
                seekAudio(29);
              }}
              onMouseEnter={() => {
          ...
          <g id="part_29">
            <path
              ...
              style={{ fill: audioControl[28].color, strokeWidth: "0px" }}
              onClick={() => {
                seekAudio(28);
              }}
              onMouseEnter={() => {
          ...
          <g id="part_28">
            <path
              ...
              style={{ fill: audioControl[27].color, strokeWidth: "0px" }}
              onClick={() => {
                seekAudio(27);
              }}
              onMouseEnter={() => {
          ...
          <g id="part_27">
            <path
              ...
              style={{ fill: audioControl[26].color, strokeWidth: "0px" }}
              onClick={() => {
                seekAudio(26);
              }}
              onMouseEnter={() => {
          ...
          <g id="part_26">
            <path
              ...
              style={{ fill: audioControl[25].color, strokeWidth: "0px" }}
              onClick={() => {
                seekAudio(25);
              }}
              onMouseEnter={() => {
          ...
          <g id="part_25">
            <path
              ...
              style={{ fill: audioControl[24].color, strokeWidth: "0px" }}
              onClick={() => {
                seekAudio(24);
              }}
              onMouseEnter={() => {
          ...
          <g id="part_24">
            <path
              ...
              style={{ fill: audioControl[23].color, strokeWidth: "0px" }}
              onClick={() => {
                seekAudio(23);
              }}
              onMouseEnter={() => {
          ...
          <g id="part_23">
            <path
              ...
              style={{ fill: audioControl[22].color, strokeWidth: "0px" }}
              onClick={() => {
                seekAudio(22);
              }}
              onMouseEnter={() => {
          ...
          <g id="part_22">
            <path
              ...
              style={{ fill: audioControl[21].color, strokeWidth: "0px" }}
              onClick={() => {
                seekAudio(21);
              }}
              onMouseEnter={() => {
          ...
          <g id="part_21">
            <path
              ...
              style={{ fill: audioControl[20].color, strokeWidth: "0px" }}
              onClick={() => {
                seekAudio(20);
              }}
              onMouseEnter={() => {
          ...
          <g id="part_20">
            <path
              ...
              style={{ fill: audioControl[19].color, strokeWidth: "0px" }}
              onClick={() => {
                seekAudio(19);
              }}
              onMouseEnter={() => {
          ...
          <g id="part_19">
            <path
              ...
              style={{ fill: audioControl[18].color, strokeWidth: "0px" }}
              onClick={() => {
                seekAudio(18);
              }}
              onMouseEnter={() => {
          ...
          <g id="part_18">
            <path
              ...
              style={{ fill: audioControl[17].color, strokeWidth: "0px" }}
              onClick={() => {
                seekAudio(17);
              }}
              onMouseEnter={() => {
          ...
          <g id="part_17">
            <path
              ...
              style={{ fill: audioControl[16].color, strokeWidth: "0px" }}
              onClick={() => {
                seekAudio(16);
              }}
              onMouseEnter={() => {
          ...
          <g id="part_16">
            <path
              ...
              style={{ fill: audioControl[15].color, strokeWidth: "0px" }}
              onClick={() => {
                seekAudio(15);
              }}
              onMouseEnter={() => {
          ...
          <g id="part_15">
            <path
              ...
              style={{ fill: audioControl[14].color, strokeWidth: "0px" }}
              onClick={() => {
                seekAudio(14);
              }}
              onMouseEnter={() => {
          ...
          <g id="part_14">
            <path
              ...
              style={{ fill: audioControl[13].color, strokeWidth: "0px" }}
              onClick={() => {
                seekAudio(13);
              }}
              onMouseEnter={() => {
          ...
          <g id="part_13">
            <path
              ...
              style={{ fill: audioControl[12].color, strokeWidth: "0px" }}
              onClick={() => {
                seekAudio(12);
              }}
              onMouseEnter={() => {
          ...
          <g id="part_12">
            <path
              ...
              style={{ fill: audioControl[11].color, strokeWidth: "0px" }}
              onClick={() => {
                seekAudio(11);
              }}
              onMouseEnter={() => {
          ...
          <g id="part_11">
            <path
              ...
              style={{ fill: audioControl[10].color, strokeWidth: "0px" }}
              onClick={() => {
                seekAudio(10);
              }}
              onMouseEnter={() => {
          ...
          <g id="part_10">
            <path
              ...
              style={{ fill: audioControl[9].color, strokeWidth: "0px" }}
              onClick={() => {
                seekAudio(9);
              }}
              onMouseEnter={() => {
          ...
          <g id="part_9">
            <path
              ...
              style={{ fill: audioControl[8].color, strokeWidth: "0px" }}
              onClick={() => {
                seekAudio(8);
              }}
              onMouseEnter={() => {
          ...
          <g id="part_8">
            <path
              ...
              style={{ fill: audioControl[7].color, strokeWidth: "0px" }}
              onClick={() => {
                seekAudio(7);
              }}
              onMouseEnter={() => {
          ...
          <g id="part_7">
            <path
              ...
              style={{ fill: audioControl[6].color, strokeWidth: "0px" }}
              onClick={() => {
                seekAudio(6);
              }}
              onMouseEnter={() => {
          ...
          <g id="part_6">
            <path
              ...
              style={{ fill: audioControl[5].color, strokeWidth: "0px" }}
              onClick={() => {
                seekAudio(5);
              }}
              onMouseEnter={() => {
          ...
          <g id="part_5">
            <path
              ...
              style={{ fill: colorsReference[4], strokeWidth: "0px" }}
              onClick={() => {
                seekAudio(4);
              }}
              onMouseEnter={() => {
          ...
          <g id="part_4">
            <path
              ...
              style={{ fill: colorsReference[3], strokeWidth: "0px" }}
              onClick={() => {
                seekAudio(3);
              }}
              onMouseEnter={() => {
          ...
          <g id="part_3">
            <path
              ...
              style={{ fill: colorsReference[2], strokeWidth: "0px" }}
              onClick={() => {
                seekAudio(2);
              }}
              onMouseEnter={() => {
          ...
          <g id="part_2">
            <path
              ...
              style={{ fill: colorsReference[1], strokeWidth: "0px" }}
              onClick={() => {
                seekAudio(1);
              }}
              onMouseEnter={() => {
          ...
          <g id="part_1">
            <path
              ...
              style={{ fill: colorsReference[0], strokeWidth: "0px" }}
              onClick={() => {
                seekAudio(0);
              }}
              onMouseEnter={() => {
